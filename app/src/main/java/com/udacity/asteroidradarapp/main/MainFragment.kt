...
import com.udacity.asteroidradarapp.databinding.FragmentMainBinding
...
class MainFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        viewModel.navigateToDetailAsteroid.observe(viewLifecycleOwner, Observer { asteroid ->
            if (asteroid != null) {
                this.findNavController().navigate(MainFragmentDirections.actionNavigateToDetail(asteroid))
